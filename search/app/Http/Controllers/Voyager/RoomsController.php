...
class RoomsController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        //        $jihozlar = Jihozlar::get(['title','id']);
        $jihozlar = Jihozlar::all();
//        $price = Price::get(['title','id']);
        $price = Price::all();

        return Voyager::view($view, compact('dataType', 'jihozlar','price','dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
...
//        $price = Price::get(['title','id']);
        ...
        return Voyager::view($view, compact('dataType', 'jihozlar','price','dataTypeContent', 'isModelTranslatable'));
    }
